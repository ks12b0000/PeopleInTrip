...
<body>
	...
	<div style=" text-align: center; font-size: 20px;"><strong>글 번호 : </strong>${replyUpdate.post_num}</div>	
		<section id="container" style=" text-align: center; margin-top: 15px;">
				<form name="updateForm" role="form" method="post" action="${contextPath}/board/boardreplyUpdate">
	...
	<script>
		$(document).ready(function() {
			...
			$(".cancel_btn").on("click", function() {
				location.href = "${contextPath}/board/community_detail.do?post_num=${replyUpdate.post_num}";
			})
		})
	</script>
	<script>
