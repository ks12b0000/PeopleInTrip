...
<script type="text/javascript">
    	...
    	function fn_removeModImage(_imageFileNO, post_num, _imageFileName) {
			...
			$.ajax({
				type: "post",
				url: "${contextPath}/board/removeMod1.do",
				dataType: "text",
				data: {imageFileNO: _imageFileNO, post_num: post_num, imageFileName: _imageFileName},
				success: function(result, textStatus) {
					if (result == 'success') {
						alert("이미지를 삭제했습니다.")
						location.href="${contextPath}/board/modBoard1.do?removeCompleted=true&post_num=" + post_num;
				...
				<div class="main-board">
					...
					<div>
						<section class="content-first">
							<p class="write-detail">정보게시판 > 수정하기</p>
						</section>
					</div>
					<!-- 정보게시판 제목입력, 내용입력 -->
