			...
			<div style="text-align: center; font-size: 18px;">
				<ul>
					<c:if test="${pageMaker.cri.page > 1 }">
						<a
							href="${contextPath}/tourist/busanfestival_PageList11?page=1&searchType=${pageMaker2.cri.searchType }&keyword=${pageMaker2.cri.keyword}"
							style="color: #9966ff; font-size: 25px;">&laquo;</a>
						<a
							href="${contextPath}/tourist/busanfestival_PageList11?&page=${pageMaker2.cri.page-1 }&searchType=${pageMaker2.cri.searchType }&keyword=${pageMaker2.cri.keyword}"
                  ...
                  <a
							href="${contextPath}/tourist/busanfestival_PageList11${pageMaker2.makeSearch(idx)}"
					...
					<c:if test="${pageMaker2.cri.page < pageMaker2.endPage}">
						<a
							...
							style="color: #9966ff; font-size: 25px;">&gt;</a>
						<a
							href="${contextPath}/tourist/busanfestival_PageList11?&page=${pageMaker2.endPage}&searchType=${pageMaker2.cri.searchType }&keyword=${pageMaker2.cri.keyword}"
