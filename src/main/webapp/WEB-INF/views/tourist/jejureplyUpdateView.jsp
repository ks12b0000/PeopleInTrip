...
<body>
	...
	<div style=" text-align: center; font-size: 20px;"><strong>글 번호 : </strong>${replyUpdate.contentsid}</div>	
		<section id="container" style=" text-align: center; margin-top: 15px;">
				<form name="updateForm" role="form" method="post" action="${contextPath}/tourist/jejureplyUpdate">
					<input type="hidden" name="contentsid" value="${replyUpdate.contentsid}" readonly="readonly"/>
	...
	<script>
		$(document).ready(function() {
			...
			$(".cancel_btn").on("click", function() {
				location.href = "${contextPath}/tourist/tourist_View?contentsid=${replyUpdate.contentsid}";
			})
		})
	</script>
	<script>
