...
<body>
	...
	<div style=" text-align: center; font-size: 20px;"><strong>글 번호 : </strong>${replyUpdate.UC_SEQ}</div>	
		<section id="container" style=" text-align: center; margin-top: 15px;">
				<form name="updateForm" role="form" method="post" action="${contextPath}/tourist/busanreplyUpdate3">
					<input type="hidden" name="UC_SEQ" value="${replyUpdate.UC_SEQ}" readonly="readonly"/>
	...
	<script>
		$(document).ready(function() {
			...
			$(".cancel_btn").on("click", function() {
				location.href = "${contextPath}/tourist/busanexperience_View?UC_SEQ=${replyUpdate.UC_SEQ}";
			})
		})
	</script>
	<script>
