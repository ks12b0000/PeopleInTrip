...
<body>
    ...
    <div id="header-jeh">
       <header>
		...
		<input type="hidden" name="articleNO" value="${boardMap.post_num }">
...
<%--         <div class="write-form">
        	...
        	<button type="button" class="write-form-edit" onclick="location.href='${contextPath}/board/modBoard.do?post_num=${boardMap.post_num }'">수정</button>
        	<button type="button" class="write-form-delete" onclick="location.href='${contextPath}/board/removeBoard.do?post_num=${boardMap.post_num }'">삭제</button>
        	</c:if>
        </div> --%>
    </section>
    </div>
