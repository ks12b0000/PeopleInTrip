...
public class LoginController {
   ...
   MemberDTO user = memberService.find_id(memberDTO);
	...
	public String findPasswordAction(MemberDTO memberDTO, Model model) throws Exception {
	...
	public String updatePasswordAction(@RequestParam(value = "updateid", defaultValue = "", required = false) String id, MemberDTO memberDTO) throws Exception {
		memberDTO.setId(id);
	...
	public String loginGooglePOST(MemberDTO memberDTO, HttpSession session, RedirectAttributes rttr, MemberDTO mmemberDTO) throws Exception{
		...
		else if(mvo_ajaxid.equals(returnDTO.getId())){ 
			//구글 로그인
	...
	public ModelAndView signupCertifyEmail (@RequestParam(value="email", required = false)String email2, 
		...
		log.info("here_emailcerti: " + email2);
	...
	public ResponseEntity<String> duplicateCheckId(@RequestParam("id") String id, HttpServletRequest request, HttpServletResponse response) throws Exception {
		log.info("here_idDup " + id);
	...
	public ResponseEntity<String> duplicateCheckNick(@RequestParam("nick_nm") String nick_nm, HttpServletRequest request, HttpServletResponse response) throws Exception {
		log.info("here_nickDup " + nick_nm);
	...
	public ResponseEntity<String> duplicateCheckEmail(@RequestParam("email") String email, HttpServletRequest request, HttpServletResponse response) throws Exception {
		log.info("here_emailDup " + email);
